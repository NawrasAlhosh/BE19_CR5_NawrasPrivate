...
$first_name = $last_name = $password = $email = $phone_number = $address = ""; // Initialize variables
$first_nameError = $last_nameError = $passwordError = $emailError = $phone_numberError = $addressError = ""; // Initialize error messages
...
if (isset($_POST["sign-up"])) {
  ...
  $picture = cleanInputs($_POST["picture"]);
  ...
  if (!$error) { // If there is no error with any input, data will be inserted into the database
  ...
  <div class="container">
    ...
    <form method="post" autocomplete="off">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="picture" name="picture" placeholder="Profile Picture">
      </div>
      <div class="mb-3">
